...
% Funcion para la aplicacion de la Ley de Biot-Savart
...
% necesarios para la obtencion del factor de influencia: rPQ . rrP y rPQ . rrQ
...
% influencia.
    ...
    Velocidad_z=1/4/pi.*rrPxrrQ_z./(modulo_rrPxrrQ_2+1e-12).*(prod_escalar_rPQrrP./modulo_rrP-prod_escalar_rPQrrQ./modulo_rrQ);
    Velocidad_y=1/4/pi.*rrPxrrQ_y./(modulo_rrPxrrQ_2+1e-12).*(prod_escalar_rPQrrP./modulo_rrP-prod_escalar_rPQrrQ./modulo_rrQ);
    Velocidad_x=1/4/pi.*rrPxrrQ_x./(modulo_rrPxrrQ_2+1e-12).*(prod_escalar_rPQrrP./modulo_rrP-prod_escalar_rPQrrQ./modulo_rrQ);
